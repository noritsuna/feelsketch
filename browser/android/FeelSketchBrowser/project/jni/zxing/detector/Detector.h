...
namespace qrcode {
  namespace detector {
    ...
    private:
      ...
      Ref<DetectorResult> result_;
      Ref<AlignmentPattern> alignmentPattern_;
      Ref<PointMatrix> pointMatrix_;
      ...
      float sizeOfBlackWhiteBlackRun(int fromX, int fromY, 
                                     int toX, int toY);
      int findAlignmentInRegion(float overallEstModuleSize,
                                                   int estAlignmentX,
                                                   int estAlignmentY,
